        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '36px', alignItems: 'center' }}>
          <div style={{ flex: '1 1 480px', minWidth: '320px' }}>
            ...
            <div style={{ display: 'grid', gap: '16px', marginTop: '24px' }}>
              <div style={{ padding: '24px', background: 'var(--bg-primary)', borderRadius: '20px', border: '1px solid var(--border-color)', transition: 'background-color 0.3s' }}>
                <h3 style={{ margin: 0, fontSize: '1.1rem', color: 'var(--text-primary)', fontWeight: 700 }}>Customer-first always</h3>
                <p style={{ margin: '12px 0 0', color: 'var(--text-secondary)', lineHeight: 1.8 }}>Clean tools without spam, push notifications, or gimmicks.</p>
              </div>
              <div style={{ padding: '24px', background: 'var(--bg-primary)', borderRadius: '20px', border: '1px solid var(--border-color)', transition: 'background-color 0.3s' }}>
                <h3 style={{ margin: 0, fontSize: '1.1rem', color: 'var(--text-primary)', fontWeight: 700 }}>Platform reliability</h3>
                <p style={{ margin: '12px 0 0', color: 'var(--text-secondary)', lineHeight: 1.8 }}>Tools built to perform through market volatility.</p>
              </div>
            </div>

      ...
      <div className="container">
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '40px', alignItems: 'center' }}>
          <div style={{ flex: '1 1 480px', minWidth: '320px' }}>
            ...
            <h2 style={{ margin: '18px 0 20px', fontSize: '2.5rem', color: 'var(--text-primary)', lineHeight: 1.05, fontWeight: 700 }}>
              Resources that help you trade smarter.
            </h2>
            <p style={{ color: 'var(--text-secondary)', fontSize: '1rem', lineHeight: 1.9, marginBottom: '24px' }}>
              Access research reports, weekly market calls, and education tools without the noise.
            </p>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '16px' }}>
              <article style={{ padding: '22px', borderRadius: '18px', border: '1px solid var(--border-color)', background: 'var(--bg-secondary)', transition: 'background-color 0.3s, border-color 0.3s' }}>
                <p style={{ margin: 0, fontWeight: 700, color: 'var(--text-primary)' }}>Expert insights</p>
                <p style={{ margin: '10px 0 0', color: 'var(--text-secondary)', fontSize: '0.95rem' }}>Curated market commentary every day.</p>
              </article>
              <article style={{ padding: '22px', borderRadius: '18px', border: '1px solid var(--border-color)', background: 'var(--bg-secondary)', transition: 'background-color 0.3s, border-color 0.3s' }}>
                <p style={{ margin: 0, fontWeight: 700, color: 'var(--text-primary)' }}>Learning tracks</p>
                <p style={{ margin: '10px 0 0', color: 'var(--text-secondary)', fontSize: '0.95rem' }}>Beginner to advanced trading modules.</p>
              </article>
            </div>

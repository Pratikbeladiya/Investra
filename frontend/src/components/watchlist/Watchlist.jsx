...
const Watchlist = ({ onOpenTransaction }) => {
  ...
  // Reset search whenever user navigates to a different page
  // This prevents stale search query from hiding stocks
  useEffect(() => {
    setSearchQuery("");
    if (inputRef.current) {
  ...
  // Extra guard: forcibly clear any browser-autofilled value after mount
  // Chrome autofills text inputs near password fields (Settings page)
  useEffect(() => {
  ...
  const handleSearchChange = (e) => {
    ...
    // Guard: reject any value that looks like an email (browser autofill artifact)
  ...
  return (
    <div className="watchlist-container">
      <div className="search-container">
        {/* 
          autoComplete="new-password" is the most reliable trick to block 
          Chrome autofill — even "off" is ignored by Chrome for text fields 
          near password forms. "new-password" is always respected.
        */}
        <input
          ref={inputRef}
          type="text"

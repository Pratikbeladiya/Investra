...
function OpenAccount() {
  return (
    <section style={{ padding: '80px 0', backgroundColor: 'var(--bg-primary)', transition: 'background-color 0.3s', borderTop: '1px solid var(--border-color)' }}>
      <div className="container">
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '32px', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ flex: '1 1 420px', minWidth: '320px' }}>
            ...
            <p style={{ margin: 0, color: 'var(--text-secondary)', fontSize: '1rem', lineHeight: 1.9, maxWidth: '560px' }}>

        ...
        <div className="funds-left" style={styles.leftCol}>
          <div style={styles.card}>
            <div style={styles.balanceHeader}>
              <p style={{ color: "var(--text-secondary)", fontSize: "0.85rem", marginBottom: "6px", fontWeight: "500" }}>Available Margin</p>
              <h1 style={{ fontSize: "1.85rem", margin: 0, fontWeight: "800", color: "var(--text-primary)" }}>₹{balance.toLocaleString("en-IN", { minimumFractionDigits: 2 })}</h1>
              <p style={{ color: "var(--text-secondary)", fontSize: "0.75rem", marginTop: "4px" }}>Total funds available for trading</p>
            </div>

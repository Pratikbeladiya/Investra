...
const Account = () => {
  ...
  const handleTabChange = (event, newValue) => {
    ...
    const paths = ['/profile', '/statements', '/settings'];
  ...
  return (
    <Box sx={{
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', mb: 4, gap: 3 }}>
        ...
        <Box>
          <Typography variant="h6" fontWeight="900" color="var(--text-primary)" sx={{ fontSize: '1.2rem' }}>
      ...
      <Box sx={{ borderBottom: 1, borderColor: 'var(--border-color)', mb: 4 }}>
        ...
        >
          <Tab label="Profile" sx={{ fontSize: '0.8rem !important' }} />
          <Tab label="Statements" sx={{ fontSize: '0.8rem !important' }} />
          <Tab label="Settings" sx={{ fontSize: '0.8rem !important' }} />
        </Tabs>
      </Box>
        ...
        <Box sx={{ maxWidth: 620 }}>
          <Paper elevation={0} sx={{ borderRadius: 4, border: '1px solid var(--border-color)', background: 'var(--card-bg)', mb: 3, overflow: 'hidden' }}>
            <Box sx={{ px: 2.5, pt: 2.5, pb: 1 }}>
              <Typography variant="subtitle2" fontWeight="900" color="var(--text-primary)" sx={{ fontSize: '0.88rem' }}>Personal Details</Typography>
            </Box>
            ...
            <Box sx={{ px: 2.5, py: 1.8, borderTop: '1px solid var(--border-color)' }}>
              ...
              <Typography fontWeight="700" color="var(--text-primary)" sx={{ fontSize: '0.88rem', mt: 0.2 }}>{user?.username}</Typography>
            </Box>
      ...
      {tabValue === 1 && (
        <Box>
          <Typography variant="subtitle1" fontWeight="700" mb={3} color="var(--text-primary)">Recent Statements</Typography>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={7}>
            <Paper elevation={0} sx={{ p: 3, borderRadius: 4, border: '1px solid var(--border-color)', background: 'var(--card-bg)' }}>
              <Typography variant="subtitle1" fontWeight="700" mb={3} color="var(--text-primary)">Account Settings</Typography>
              <List>
                <ListItem sx={{ px: 0 }}>

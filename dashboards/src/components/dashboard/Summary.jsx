          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-buttons">
              <button
                ...
                onClick={() => { navigate('/ipo'); setShowExploreModal(false); }}
              >
                Explore IPOs
              </button>
              <button
                className="modal-action-btn"
                onClick={() => { navigate('/mutual-funds'); setShowExploreModal(false); }}
              >
                Explore Mutual Funds
              </button>
              <button
                className="modal-action-btn"
                onClick={() => { navigate('/etfs'); setShowExploreModal(false); }}
              >
                Explore ETFs
              </button>
              <button
                className="modal-action-btn"
                onClick={() => { navigate('/bonds'); setShowExploreModal(false); }}
              >
                Explore Bonds
              </button>
            </div>

        ...
        <div className="menu-container">
          <div className="menus">
            <ul className="menus-list">
              {[
                { label: "Dashboard", path: "/", id: 0 },
                { label: "Orders", path: "/orders", id: 1 },
                { label: "Holdings", path: "/holdings", id: 2 },
                { label: "Positions", path: "/positions", id: 3 },
                { label: "Funds", path: "/funds", id: 4 },
                { label: "Apps", path: "/apps", id: 6 }
              ].map((item) => (
                <li key={item.id}>
                  <Link
            ...
            >
              ...
              >
                ...
                <ListItemText
                  ...
                  primaryTypographyProps={{ fontWeight: 700, fontSize: '0.8rem', color: 'var(--text-secondary)' }}
                  secondaryTypographyProps={{ fontWeight: 900, fontSize: '1rem', color: 'var(--accent-color)', mt: 0.3 }}
                />
              </MenuItem>

              <Divider sx={{ my: 1, borderColor: 'var(--border-color)' }} />

              <MenuItem component={Link} to="/profile" onClick={handleClose} sx={{ py: 1.2, px: 3 }}>
              ...
              <MenuItem component={Link} to="/statements" onClick={handleClose} sx={{ py: 1.2, px: 3 }}>
              ...
              <MenuItem component={Link} to="/settings" onClick={handleClose} sx={{ py: 1.2, px: 3 }}>
